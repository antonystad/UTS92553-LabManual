  ...
  <colgroup>
    ...
    <tbody style="border-bottom: 1px solid #ddd">
        <tr style="background-color: #CAEEFB">
            <td><b>Target Muscle 1</b></td>
            <td style="text-align: left">
              <div contenteditable></div></td>
        </tr>
        <tr>
            <td><b>Electrode Positioning</b></td>
            <td style="text-align: left">
              <div contenteditable></div></td>
        </tr>
        <tr>
            <td><b>Objective Assessment</b></td>
            <td style="text-align: left">
                <div contenteditable></div>
            </td>
        </tr>
        <tr>
            <td><b>Subjective Assessment</b></td>
            <td style="text-align: left">
                <div contenteditable></div>
            </td>
        </tr>
...
<table>
    ...
    <tbody style="border-bottom: 1px solid #ddd">
        <tr>
            <td colspan="1"><b>Now that you've had a chance to play around with the EMS devices, what considerations would you make before implementing this tool in practice?</b></td>
      </tr>    
        <tr>
            <td style="text-align: left">
                <div contenteditable></div>
...
<table>
    ...
    <tbody style="border-bottom: 1px solid #ddd">
        <tr>
            <td colspan="1"><b>Think about some creative ways that this tool could be used in clinical, general, or athletic populations - what settings would you be interested in researching to see if EMS can be useful for improving, maintaining, or restoring function?</b></td>
      </tr>    
        <tr>
            <td style="text-align: left">
                <div contenteditable></div>
