...
Exercise adherence is an important consideration in any program. There are many contributing elements to this complex issue and, while research continually builds around the topic, societal exercise habits about exercise participation are not improving. This tutorial content presents a range of questionnaires that provide non-physical methods to assess fitness, health, and functional capacity along with some of the typically reported barriers to exercise.

The questionnaires are included for you to become familiar with by reading and completing them first from your own perspective, then identifying questionnaire items that would be particularly challenging for an individual living with a chronic condition. Consider a range of symptoms that would typically be present in an individual with a cardiopulmonary, metabolic, musculoskeletal, or neuromuscular condition when assessing the impact on a person's responses to the questionnaires.
...
When using the CVD Risk Calculator, you may need to modify your age for the assessment to work. Use your current details to identify your risk assuming a continuation of your current health state.
...
<table>
  ...
  <tbody>
    <tr>
      <td style="text-align:right">Cannot do at all</td>
      <td colspan="9"></td>
      <td style="text-align:left">Certain can do</td>
    </tr>
  </tbody>
</table>
```
...
<table>
  ...
  <tbody>
    <tr>
      <td style="text-align:right">Not Confident</td>
      <td colspan="9"></td>
...
Physical activity is a proven method for achieving and maintaining a negative energy balance. Monitoring physical activity is important in two main ways:
...
For more information about this program, go to [10000steps.org.au](http://www.10000steps.org.au). In January 2026, they report that their 716,604 members have logged a grand total of 470,955,491,444 steps! Similar gamification or reward models exist, for example [Qantas Wellbeing](https://insurance.qantas.com/wellbeing/qantaswellbeingapp).
...
```{=html}
<table>
  <caption>GPS vs Pedometer Data Comparison</caption>
  <colgroup>
    <col style="width:40%">
    <col style="width:20%">
    <col style="width:20%">
  ...
  <thead>
    <tr>
      <th>Activity</th>
      <th>Slow Walk<br><sub>3.6km/h or 1.0m/s</sub></th>
      <th>Fast Walk<br><sub>6.0km/h or 1.7m/s</sub></th>
      <th>Running<br><sub>10km/h or 2.8m/s</sub></th>
    </tr>
  </thead>
  <tbody style="border-bottom: 1px solid #ddd">
    <tr>
      <td>Approximate step length (m)</td>
      <td><div contenteditable></div></td>
      <td><div contenteditable></div></td>
      <td><div contenteditable></div></td>
    </tr>
    <tr>
      <td>Actual - Counted Steps<br><sub>Number counted by testers</sub></td>
      <td><div contenteditable></div></td>
      <td><div contenteditable></div></td>
      <td><div contenteditable></div></td>
    </tr>
    <tr>
      <td>Actual - Measured Distance (m)<br><sub>Distance walked on track</sub></td>
      <td><div contenteditable></div></td>
      <td><div contenteditable></div></td>
      <td><div contenteditable></div></td>
    </tr>
    <tr>
      <td>GPS - Reported Distance (m)</td>
      <td><div contenteditable></div></td>
      <td><div contenteditable></div></td>
      <td><div contenteditable></div></td>
    </tr>
    <tr>
      <td>Pedometer - Reported Steps</td>
      <td><div contenteditable></div></td>
      <td><div contenteditable></div></td>
      <td><div contenteditable></div></td>
    </tr>
    <tr>
      <td>Pedometer - Calculated Distance (m)<br><sub>Reported Steps × Step Length</sub></td>
      <td><div contenteditable></div></td>
      <td><div contenteditable></div></td>
      <td><div contenteditable></div></td>
    </tr>
    <tr>
      <td>Phone - Reported Steps</td>
      <td><div contenteditable></div></td>
      <td><div contenteditable></div></td>
      <td><div contenteditable></div></td>
    </tr>
    <tr>
      <td>Phone - Calculated Distance (m)<br><sub>Reported Steps × Step Length</sub></td>
      <td><div contenteditable></div></td>
      <td><div contenteditable></div></td>
      <td><div contenteditable></div></td>
    </tr>
